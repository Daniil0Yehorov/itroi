...
public class domParser {
        ...
        try {
            ...
            for (int i = 0; i < cartNodes.getLength(); i++) {
                ...
                if (productIdsWrapper.getLength() > 0) {
                    ...
                    List<Integer> ids = productIDs.getProductID();
                    for (int j = 0; j < productIdNodes.getLength(); j++) {
                        ids.add(Integer.parseInt(productIdNodes.item(j).getTextContent()));
                    }
    ...
    public void marshal(StoreData storeData, String outputPath) {
        try {
            ...
            for (Product product : storeData.getProducts().getProduct()) {
            ...
            for (Cart cart : storeData.getCarts().getCart()) {
                ...
                for (Integer productID : cart.getProductIDs().getProductID()) {
            ...
            for (User user : storeData.getUsers().getUser()) {
    ...
    public static void main(String[] args) {
        ...
        //with invalid data
        com.itroi.itroi.parser.domParser domParser1 = new domParser("C:/Users/Даниил/Рабочий стол/itroi/invalid_storeData.xml");
